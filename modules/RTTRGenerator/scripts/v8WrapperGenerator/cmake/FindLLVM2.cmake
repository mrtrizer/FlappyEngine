...
set (LLVM_INSALL_DIR, "/usr/local/opt/llvm/")
if (LLVM_INSTALL_DIR)
...
string(REPLACE " " ";" SEXY_LIST ${LLVM_MODULE_LIBS})

foreach(LIB_FLAG ${SEXY_LIST})
    string(SUBSTRING "${LIB_FLAG}" 2 100 NAME)
    message (STATUS ${NAME})
    add_one_lib(${NAME})
endforeach(LIB_FLAG)
